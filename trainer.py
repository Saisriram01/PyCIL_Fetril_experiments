...
def _train(args):
    ...
    for task in range(data_manager.nb_tasks):
        ...
        print(f"Training the model - Task {task}")
        ...
        if args["save_model"]:
            if args["save_model"] == "Task":
                model.save_checkpoint(args["label"])
            elif args["save_model"] == "Base_Only" and task == 0:
                pass
                model.save_checkpoint(args["label"])
